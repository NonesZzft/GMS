            ...
            <div class="outter-wp">
                ...
                <div class="sub-heard-part">
                    <ol class="breadcrumb m-b-0">
                        <li>
                            <a href="comIndex.jsp">主页</a>
                        </li>
                        <li>
                            <a href="FindPositionServlet?currentPage=0">发布的职位列表</a>
                        </li>
                        <li class="active">添加职位信息</li>
                    </ol>
                </div>
                <!--//sub-heard-part-->
                <div class="graph-visual tables-main">
                    <h3 class="inner-tittle two">添加职位信息</h3>
                    <div class="graph">
                        <div class="tables">
                            <%
                            ...
                            %>
                            <form style="align:center" action="AddPositionServlet" method="post">
                                <p>职位：<input type="text" name="Composition"></p>
                                <p>数量：<input type="text" name="Comamount"></p>
                                <p>工资：<input type="text" name="Comsalary"></p>
                                <p>要求：<input type="text" name="Comcondition"></p>
                                <p>企业id：<input type="text" name="PoComid"></p>
