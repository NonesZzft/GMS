<%@ page import="com.hwadee.pojo.ComPos"%>
			...
			<div class="inner-content">
				...
				<div class="sub-heard-part">
					<ol class="breadcrumb m-b-0">
						...
						<li><a href="FindPositionServlet?currentPage=0">发布的职位列表</a></li>
						<li class="active">修改职位信息</li>
					</ol>
				</div>
				<!--//sub-heard-part-->
				<div class="graph-visual tables-main">
					<h3 class="inner-tittle two">修改职位信息</h3>
					<div class="graph">
						<div class="tables">
							<%
								ComPos compos = new ComPos();
								compos = (ComPos) session.getAttribute("specific_position");
								request.setCharacterEncoding("utf-8");
							%>
							<form style="align: center" action="UpdatePositionServlet"
								method="post">
								<p>
									职位：<input type="text" name="Composition"
										value="<%=compos.getComposition()%>" readonly>
								</p>
								<p>
									数量：<input type="text" name="Comamount"
										value="<%=compos.getComamount()%>">
								</p>
								<p>
									工资：<input type="text" name="Comsalary"
										value="<%=compos.getComsalary()%>">
								</p>
								<p>
									职位要求：<input type="text" name="Comcondition"
										value="<%=compos.getComcondition()%>">
								</p>
								<p>
									职位要求：<input type="text" name="PoComid"
										value="<%=compos.getPoComid()%>" readonly>
								</p>
