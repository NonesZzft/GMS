        ...
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <div class="graph-visual tables-main">
                    <h3 class="inner-tittle two" style="display: inline">企业列表</h3>
                    <form style="align:center;display: inline;" action="comList_add.jsp" method="post">
                        <input style="display: inline;border: none" type="image" src="images/add.jpg">
                    </form>
                    <div class="graph">
                        <div class="tables">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><%=list.get(i).getComname()%></td>
                                    <td><%=list.get(i).getComtelephone()%></td>
                                    <td><%=list.get(i).getCommail()%></td>
                                    <td>
                                        <form style="align:center;display: inline;" action="FindSpecificCompanyServ?id=<%=list.get(i).getComid()%>" method="post">
                                            <input type="submit" value="编辑">
                                        </form>
                                        <form style="align:center;display: inline" action="DelCompanyServ?id=<%=list.get(i).getComid()%>" onsubmit="return sumbit_form()" method="post">
                                            <input style="background-color: #C31916; display: inline" type="submit" value="删除">
                                        </form>
                                    </td>
                                </tr>
                                <%
                            ...
                            %>
                            <span><a href="FindCompanyServ?currentPage=1">[第一页]</a> </span> <span><a
                                href="FindCompanyServ?currentPage=<%=currentPage - 1%>">[上一页]</a> </span>
                            <%
                                }
                            ...
                            %>
                            <span><a href="FindCompanyServ?currentPage=<%=i%>"><%=i%></a>
			                </span>
                            <%
                                }
                                }
                            ...
                            %>
                            <span><a
                                    href="FindCompanyServ?currentPage=<%=currentPage + 1%>">[下一页]</a> </span> <span><a
                                href="FindCompanyServ?currentPage=<%=pageCount%>">[最后一页]</a> </span>
                            <%
                                }
                            %>
                            <form action="FindCompanyServ" id="frm" style="display: inline;">
