...
<%@ page import="com.hwadee.pojo.Note" %>
    ...
    <div class="left-content">
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <div class="sub-heard-part">
                    <ol class="breadcrumb m-b-0">
                        ...
                        <li class="active">发布公告管理</li>
                    </ol>
                </div>
                <!--//sub-heard-part-->
                <div class="graph-visual tables-main">
                    <h3 class="inner-tittle two" style="display: inline">发布公告列表</h3>
 
                    <div class="graph">
                        <div class="tables" style="align:center">
                            ...
                            <table class="table table-bordered" style="text-align:center">
                                ...
                                <tr>
                                    <%--<th scope="row">1</th>--%>
                                    <td><%=list.get(i).getPassagename()%></td>
                                    <td><%=list.get(i).getPassagecontext()%></td>
                                    <td><%=list.get(i).getPassagevariety()%></td>
                                    <td><%=list.get(i).getPassagenumber()%></td>
                                    <td>
                                        <form style="align:center;display: inline;" action="FindSpecificNoteServ?id=<%=list.get(i).getPassagenumber()%>" method="post">
                                            <input type="submit" value="编辑">
                                        </form>
                                        <form style="align:center;display: inline" action="DelNoteServ?id=<%=list.get(i).getPassagenumber()%>" onsubmit="return sumbit_form()" method="post">
           ...
           <!-- 底部-->
                            ...
                            %>
                            <span><a href="FindNoteServ?currentPage=1">[第一页]</a> </span> <span><a
                                href="FindNoteServ?currentPage=<%=currentPage - 1%>">[上一页]</a> </span>
                            <%
                                }
                            ...
                            %>
                            <span><a href="FindNoteServ?currentPage=<%=i%>"><%=i%></a>
			                </span>
                            <%
                                }
                                }
                            ...
                            %>
                            <span><a
                                    href="FindNoteServ?currentPage=<%=currentPage + 1%>">[下一页]</a> </span> <span><a
                                href="FindNoteServ?currentPage=<%=pageCount%>">[最后一页]</a> </span>
                            <%
                                }
                            %>
                            <form action="FindNoteServ" id="frm" style="display: inline;">
