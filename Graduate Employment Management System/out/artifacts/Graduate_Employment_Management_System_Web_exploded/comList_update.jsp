            ...
            <div class="outter-wp">
                ...
                <div class="sub-heard-part">
                    <ol class="breadcrumb m-b-0">
                        ...
                        <li class="active">修改企业信息</li>
                    </ol>
                </div>
                <!--//sub-heard-part-->
                <div class="graph-visual tables-main">
                    <h3 class="inner-tittle two">修改企业信息</h3>
                    <div class="graph">
                        <div class="tables">
                            <%
                            ...
                            %>
                            <form style="align:center" action="UpdateComServ" method="post">
                                <p>企业序号：<input type="text" name="Comid" value="<%=company.getComid()%>" readonly></p>
                                <p>企业密码：<input type="text" name="Compassword" value="<%=company.getCompassword()%>"></p>
                                <p>企业名称：<input type="text" name="Comname" value="<%=company.getComname()%>"></p>
                                <p>企业电话：<input type="text" name="Comtelephone" value="<%=company.getComtelephone()%>"></p>
                                <p>企业邮箱：<input type="text" name="Commail" value="<%=company.getCommail()%>"></p>
